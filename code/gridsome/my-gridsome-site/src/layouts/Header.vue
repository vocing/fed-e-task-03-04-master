<template>
  ...
  >
    ...
    <a :href="post.html_url" target="_blank" class="btn">GitHub主页</a>
    <a :href="`${post.html_url}/vblog`" target="_blank" class="btn">博客源码</a>
  </section>
</template>
...
export default {
  ...
  metaInfo() {
    return {
      title: this.configuration.htmlTitle,
    };
  },
  data() {
    return {
  ...
  async created() {
    ...
    // this.configuration = allData[0].data;
    this.post = allData[1].data;
  },
  mounted() {
